...
class __TwigTemplate_6cb97a6ba37b029a3333848f8505913a3782a173bc3e26ba175f75edcc426314 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('¿Está seguro que desea eliminar al empleado?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger\" id=\"button\"><i class=\"fas fa-trash-alt\"></i></button>
</form>
", "user/_delete_form.html.twig", "/home/josegcm/Descargas/monolithicEquipanelec/templates/user/_delete_form.html.twig");
    }
}
