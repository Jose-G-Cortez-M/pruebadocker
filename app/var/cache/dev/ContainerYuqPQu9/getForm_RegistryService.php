...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\CableType' => ['privates', 'App\\Form\\CableType', 'getCableTypeService', true],
            'App\\Form\\ClientType' => ['privates', 'App\\Form\\ClientType', 'getClientTypeService', true],
            'App\\Form\\DescriptionTaskType' => ['privates', 'App\\Form\\DescriptionTaskType', 'getDescriptionTaskTypeService', true],
            'App\\Form\\FilterProjectsCountType' => ['privates', 'App\\Form\\FilterProjectsCountType', 'getFilterProjectsCountTypeService', true],
            'App\\Form\\MaterialType' => ['privates', 'App\\Form\\MaterialType', 'getMaterialTypeService', true],
            'App\\Form\\MovementType' => ['privates', 'App\\Form\\MovementType', 'getMovementTypeService', true],
            'App\\Form\\ProjectCloseType' => ['privates', 'App\\Form\\ProjectCloseType', 'getProjectCloseTypeService', true],
            'App\\Form\\ProjectType' => ['privates', 'App\\Form\\ProjectType', 'getProjectTypeService', true],
            'App\\Form\\TaskAddProjectType' => ['privates', 'App\\Form\\TaskAddProjectType', 'getTaskAddProjectTypeService', true],
            'App\\Form\\TaskType' => ['privates', 'App\\Form\\TaskType', 'getTaskTypeService', true],
            'App\\Form\\ToolType' => ['privates', 'App\\Form\\ToolType', 'getToolTypeService', true],
            'App\\Form\\UserAddProjectType' => ['privates', 'App\\Form\\UserAddProjectType', 'getUserAddProjectTypeService', true],
            ...
            'App\\Form\\CableType' => '?',
            'App\\Form\\ClientType' => '?',
            'App\\Form\\DescriptionTaskType' => '?',
            'App\\Form\\FilterProjectsCountType' => '?',
            'App\\Form\\MaterialType' => '?',
            'App\\Form\\MovementType' => '?',
            'App\\Form\\ProjectCloseType' => '?',
            'App\\Form\\ProjectType' => '?',
            'App\\Form\\TaskAddProjectType' => '?',
            'App\\Form\\TaskType' => '?',
            'App\\Form\\ToolType' => '?',
            'App\\Form\\UserAddProjectType' => '?',
            'App\\Form\\UserType' => '?',
